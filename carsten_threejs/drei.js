...
const THREE_BufferGeometryUtils = {
...
function blobmanGeo() {
    ...
    const combined = THREE_BufferGeometryUtils.mergeBufferGeometries([base, circ1Geo])
    // base.merge(circ2Geo)
    return combined 
}
...
function init() {
    ...
    camera.position.set(110, 360, 110)
    ...
    controls.moveTo(0, 150, 50)
    controls.rotateTo(0.6, 1.2)
